package com.buyuziyu.sumiapp.referenveapp.view;
...
import com.buyuziyu.sumiapp.referenveapp.lib.LoadingProgressDrawable;
...
public class MyPhotoView extends PhotoView {
    ...
    public static String tag = MyPhotoView.class.getSimpleName() + " | ";
    ...
    protected void onDetachedFromWindow() {
        Log.i(MTAG, tag + "onDetachedFromWindow");
    ...
    protected void onAttachedToWindow() {
        Log.i(MTAG, tag + "onAttachedToWindow");
    ...
    public void onStartTemporaryDetach() {
        Log.i(MTAG, tag + "onStartTemporaryDetach");
    ...
    public void onFinishTemporaryDetach() {
        Log.i(MTAG, tag + "onFinishTemporaryDetach");
