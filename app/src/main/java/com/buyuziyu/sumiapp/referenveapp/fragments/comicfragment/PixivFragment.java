...
public class PixivFragment extends BaseFragment {

    public static final String TAG = "TAG";
    public static final String tag = PixivFragment.class.getSimpleName() + " | ";

    public static final String childCoimcPath = Environment.getExternalStorageDirectory() +
            File.separator + "文件匣" + File.separator + "本子" + File.separator + "pixiv";
    ...
    protected View initView() {
        Log.e(TAG,tag + "PixivFragment页面被初始化了...");
